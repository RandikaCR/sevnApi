...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::prefix('Products')->group(function () {
        ...
        Route::post('/setProduct', [ProductsController::class, 'setProduct'])->name('products.setProduct');
        Route::post('/setStatus', [ProductsController::class, 'setStatus'])->name('products.setStatus');
    });
